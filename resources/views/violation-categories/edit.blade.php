            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('violation-categories.update', $violationCategory) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code', $violationCategory->code) }}" required maxlength="20"
                               class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Nama</label>
                        <input type="text" name="name" value="{{ old('name', $violationCategory->name) }}" required maxlength="150"
                               class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="points" value="{{ old('points', $violationCategory->points) }}" required min="1"
                                   class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-emerald-500 focus:border-emerald-500">
                        </div>
                    </div>
                    <div>
