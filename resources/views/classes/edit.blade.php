            ...
            <div class="bg-white rounded-lg p-6">
                ...
                <form action="{{ route('classes.update', $class) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="academic_year_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-tertiary focus:border-tertiary">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $class->name) }}" required maxlength="20" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-tertiary focus:border-tertiary">
                    </div>
                    <div>
