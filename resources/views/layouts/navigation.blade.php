<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('violation-categories.index')" :active="request()->routeIs('violation-categories.*')">
                {{ __('Pelanggaran') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('discipline-cases.index')" :active="request()->routeIs('discipline-cases.*')">
                {{ __('Kasus Pelanggaran') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('point-ledgers.index')" :active="request()->routeIs('point-ledgers.*')">
                {{ __('Buku Poin') }}
            </x-responsive-nav-link>
